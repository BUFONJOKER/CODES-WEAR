          ...
          <div className="collapse navbar-collapse" id="navcol-1">
            <ul className="navbar-nav mt-4">
              ...
              <li className="nav-item">
                ...
                <Link onClick={cartClick} className="m-2 nav-link text-white" data-bs-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
              ...
              <li className="nav-item">
                ...
                <div ref={ref} className="collapse" id="collapseExample">
                  <div className="card card-body" style={{ width: "31%", height: "200px", position: "absolute", right: 6 }}>
                    <button type="button" className="btn-close m-3" aria-label="Close" onClick={closeClick} style={{ position: "absolute", right: 0 }}></button>
                  </div>
                </div>

    ...
    <div>
      <footer className="bg-black mt-5">
        <div className="container py-4 py-lg-5">
          ...
          <hr />
          <div className="text-muted d-flex justify-content-between align-items-center pt-3 text-white">
            <p className="mb-0 text-white">Copyright © 2023 CodesWear</p>
            <ul className="list-inline mb-0">
              ...
              <li className="list-inline-item text-white">
                <Link className="text-white" href="https://www.twitter.com/" target="blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1em"
                  height="1em"
              ...
              <li className="list-inline-item text-white">
                ...
                <Link className="text-white"  href="https://www.instagram.com/" target="blank">
